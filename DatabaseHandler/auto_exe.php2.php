...
// **************************************************************************
$php__Content_add_table = "<?php \n";
$php__Content_add_table .= "\n";
$php__Content_add_table .= "session_start();";
$php__Content_add_table .= "\n";
$php__Content_add_table .= 'header("Access-Control-Allow-Origin: *");';
$php__Content_add_table .= "\n";
$php__Content_add_table .= '$servername = "localhost";';
$php__Content_add_table .= "\n";
...
for ($aa = 0; $aa < count($columnNames); $aa++) {
    ...
    $php__Content_add_table .= 'if(isset($_POST["' . $columnNames[$aa] . '"]))';
    $php__Content_add_table .= "\n";
    $php__Content_add_table .= "{";
    $php__Content_add_table .= "\n";
    $php__Content_add_table .= '$' . $columnNames[$aa] . ' = $_POST["' . $columnNames[$aa] . '"];';
    $php__Content_add_table .= "\n";
    $php__Content_add_table .= "}";
...
$php__Content_add_table .= 'require_once "src_general.php";';
$php__Content_add_table .= "\n";
$php__Content_add_table .= 'require_once $src_general."path_config.php";';
$php__Content_add_table .= "\n";
$php__Content_add_table .= 'require_once $src_general."Give_url.php";';
$php__Content_add_table .= "\n";
$php__Content_add_table .= 'require_once $src_general."DatabaseHandler.php";';
$php__Content_add_table .= "\n";
$php__Content_add_table .= 'require_once $src_general."AsciiConverter.php";';
$php__Content_add_table .= "\n";
$php__Content_add_table .= 'require_once $src_general."path_config.php";';
$php__Content_add_table .= "\n";
$php__Content_add_table .= "\n";
...
PHP;
$php__Content_add_table .= "\n";
$php__Content_add_table .= '$time = time();';
$php__Content_add_table .= "\n";
$php__Content_add_table .= '$databaseHandler->action_sql("INSERT INTO `' . $mainTableName . '` (' .$columnNames[0] . ') VALUES ($time)");';
$php__Content_add_table .= "\n";
$php__Content_add_table .= "?>";
// Définir le chemin et le nom du fichier à créer
$filePath = $source_file[0] . $columnNames[0] . '_add.php';
 array_push($include_list,$filePath);
...
if ($file) {
    // Écrire le contenu dans le fichier
    fwrite($file, $php__Content_add_table);
...
if ($fichier) {
    ...
    echo "Impossible d'ouvrir le fichier.";
        ...
        // add JS PARENT  
        $phpConte__nt_js_add_dbname .= "\n";
        $phpConte__nt_js_add_dbname .= "<script>";
    
    
        $phpConte__nt_js_add_dbname .= '    function ' . $dbname . '_add(_this) {
            var ok = new Information("' . $source_file[0] . $dbname . '_add.php"); // création de la classe 
            ok.add("' . $dbname . '", _this.title); // ajout de l\'information pour lenvoi 
            console.log(ok.info());  
            ok.push(); // envoie l\'information au code php 
        }';
        $phpConte__nt_js_add_dbname .= "\n";
        $phpConte__nt_js_add_dbname .= '    function ' . $dbname . '_add_r(_this) {
            var ok = new Information("' . $source_file[0] . $dbname . '_add.php"); // création de la classe 
            ok.add("' . $dbname . '", _this.title); // ajout de l\'information pour lenvoi 
            console.log(ok.info());  
            ok.push(); // envoie l\'information au code php
...
$phpConte__nt_js_add_dbname .= "\n";
// Définir le chemin et le nom du fichier à créer
$filePath = $source_file[0] . $mainTableName . '_admin_js.php';
array_push($include_list, $filePath);
...
if ($file) {
    // Écrire le contenu dans le fichier
    fwrite($file, $phpConte__nt_js_add_dbname);
    // Fermer le fichier après l'écriture
    fclose($file);
    echo "Le fichier a été créé avec succès.";
    echo "<br/>";
